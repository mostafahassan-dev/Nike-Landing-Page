...
function Subscribe() {
  return (
    <section id='contact-us' className='max-container flex justify-between items-center max-lg:flex-col gap-10'>
      <h2 className='text-4xl leading-[68px] lg:max-w-md font-palanquin font-bold capitalize'>Sign Up from <span className="text-coral-red">Updates</span> & Newsletter</h2>
